...
const AvailabilityCalendar: React.FC<AvailabilityCalendarProps> = ({ availability, setAvailability }) => {
            ...
            {selectedDate && (
                <div className="p-4 border rounded-md">
                    ...
                    <div className="space-y-2">
                        <Button onClick={() => handleAction('block')} variant="outline" className="w-full">Block Date</Button>
                        <Button onClick={() => handleAction('unblock')} variant="outline" className="w-full">Unblock Date</Button>
                        <div className="flex items-center gap-2 pt-2">
                            ...
                            />
                            <Button onClick={() => handleAction('setPrice')}>Set Price</Button>
                        </div>
                    </div>
                </div>
            )}
